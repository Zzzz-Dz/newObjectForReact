...
import { UserDispatchContext } from '../../globalContext.js'
    ...
    <>
        ...
        <div className="flex justify-center items-center relative h-screen">
            <div className=" relative rounded-2xl z-20  border-2 lg:w-2/3 h-3/4 w-[25rem]">
                <div className={`z-10 w-full h-full absolute top-0 left-0 opacity-20 ${navigation.state === 'idle' ? `bg-[url('http://${IP}:5006/static/YanamiLogin.png')]` : `bg-[url('http://${IP}:5006/static/YanamiLoding.png')]`} rounded-2xl bg-cover bg-no-repeat`}></div>
                <IsFrom />
            </div>
        </div>  
     </>
